...
def main():
    ...
    required_args.add_argument('-pathKeywords', type=str, nargs=1, help='', required=True)
    ...
    pathKeywords = args.pathKeywords[0]
    ...
    conv.CreateOutFile(pathOutput, pathKeywords, dataset_name, algorithmName)
